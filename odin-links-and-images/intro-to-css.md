...
Take a quick look at [CSS Legal Color Values](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value) to see how you can adjust the opacity of these colors by adding an alpha value.
...
Go to our CSS exercises repository and read the README file.
...
- [Mozilla CSS values and units](https://developer.mozilla.org/en-US/docs/Web/CSS/length) can be used to learn the various types of values possible in absolute or relative terms.
- [Interactive Scrim on Intro to CSS](https://scrimba.com/scrim/intro-to-css) covers much of the material in the lesson in an interactive form.
